...
<!--                      <span id="copy-tambah-items">
            ...
            $st_condition = array("1" => "<span style='color:black' class='label label-success'>Available</span>",
                        ...
                        foreach ($info as $inf) {
							$start_date= date("d M Y", strtotime($inf->start_date))."<br>".$st_condition[$inf->status];
        ...
        <div class="modal-content">
            ...
            <?php print $this->form_eksternal->form_open("inventory/product-tour/tour-schedule", 'role="form"')?>
                <div class="modal-body">
                    ...
                    <div class="control-group">
					<label>Status</label>
						<?php print $this->form_eksternal->form_dropdown('tampil', array(2 => "Draft", 1 => "Publish", "3" => "Delete"), array($detail[0]->status), ' id="tampil" class="form-control input-sm"');?>
					</div>
					 <div class="control-group">
