  ...
  <div class="col-xs-12">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#detail-pemakaian" id="detail-pemakaian2" data-toggle="tab"><b>History Stock</b></a></li>
            <li><a href="#mutasi-stock" id="mutasi-stock2" data-toggle="tab"><b>MUTASI STOCK</b></a></li>
        ...
        <div class="tab-content no-padding">
            ...
            <div class="chart tab-pane" id="mutasi-stock" style="position: relative; height: 300px;">
                <?php $this->load->view('main-mrp/stock-department/view-mutasi');?>
            </div>
        </div>
    </div>
  </div>
