        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="form-group">
              <div class="col-xs-6">
                <label>title</label>
                 <?php print $this->form_eksternal->form_input('brand_search_title', $this->session->userdata("brand_search_title"),
                  'class="form-control input-sm" placeholder="Title"')?>
              </div>
              <div class="col-xs-6">
                <label>code</label>
                <?php print $this->form_eksternal->form_input('brand_search_code', $this->session->userdata("brand_search_code"),
    ...
    <div class="box box-solid box-success">
        <div class="box-header">
            ...
            <div class="box-tools pull-right">
                ...
                <a href="<?php print site_url("mrp/mrp-master/add-brand")?>" class="btn btn-success btn-sm"><i class="fa  fa-plus"></i></a>
            </div>
