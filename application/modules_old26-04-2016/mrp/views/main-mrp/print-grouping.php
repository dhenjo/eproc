...
<header class="onlyprint">
  ...
  <br>Mohon dapat dikirimkan kepada kami barang-barang sbb :</div>
        </td>
    </tr>
  </table>
...
//      $kredit = ($py->pos == 2 ? $py->nominal : 0);
    ...
    $total = number_format(($py->jumlah * $py->nilai ) * $harga);
      $total2 += (($py->jumlah * $py->nilai) * $harga);
      $note2 = nl2br($py->note);
      ...
      print "<tr>"
        ...
        . "<td style='border: 2px solid black;'><center>".number_format($harga)."</center></td>"
...
ditolak max. 7 hari setelah tanggal pengiriman.<br></td>
   ...
   <tr >
      <td width="20%">&nbsp;</td>
     <td width="60%"><div style="margin-top: 5%"><b>Yang Minta : <?php print $detail[0]->pegawai_receiver." [".$detail[0]->organisasi_receiver."]"; ?></b></div></td>
     <td width="20%">&nbsp;</td>
    </tr>
  </table>
