    ...
    <div class="box box-solid box-success">
        <div class="box-header">
            ...
            <div class="box-tools pull-right">
                ...
                <a href="<?php print site_url("mrp/po/{$id_mrp_task_orders}"); ?>" type='button' class='btn bg-black btn-flat' title='Create Purchase Orders' style='width: 40px'><i class='fa fa-shopping-cart'></i></a>
