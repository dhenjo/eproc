...
//print $this->session->userdata("report_dept_search_start_month").'cc<br>';
// print $this->session->userdata("report_dept_search_end_month");
//   $as = "0,2,0,0,";
//   $cc = array("1" => "data1","2" => "data2","3" => "data3","4" => "data4");
//   $stack = array("orange", "banana");
    
//print_r($kk);
//$ss = array_splice($kk, 0,-4);
//
//print "<br>";
//print_r($ss);
//die;
...
//  
//   foreach ($cc as $ky => $val) {
//       $arr_additional[$ky] =  $val;
//   }
//    
//   $kk = array_merge($arr_additional,$stack);
