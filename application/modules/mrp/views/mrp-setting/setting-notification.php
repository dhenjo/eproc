...
<div class="row">
  <div class="col-xs-12">
    <div class="box box-solid box-success">
        <div class="box-header">
            <h3 class="box-title">List Setting Notification</h3>
            <div class="box-tools pull-right">
                <button class="btn btn-success btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <a href="<?php print site_url("mrp/mrp-setting/add-setting-notification-email-rg")?>" title="Add Setting Notification Email" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
            </div>
