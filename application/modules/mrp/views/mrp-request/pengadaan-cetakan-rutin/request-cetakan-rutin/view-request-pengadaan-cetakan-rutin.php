  ...
  <div class="col-xs-12">
    <div class="box box-solid box-success">
        <div class="box-header">
            <h3 class="box-title">List Permintaan Pengadaan Cetakan Rutin</h3>
        ...
        <div class="modal fade" id="permintaan-cetakan-rutin" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Note Cetakan Rutin</h4>
            </div>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
              <div class="col-xs-12">
                ...
                <button type='button' class='btn btn-success' data-toggle='modal' data-target='#permintaan-cetakan-rutin' isi=''>
                      Note Cetakan Rutin
              </button>
              </div>
            ...
            <tfoot>
              ...
              <?php if($list[0]->status < 6){ ?>     
                ...
                <?php if($list[0]->status < 2){
                    ...
                    <a href="<?php print site_url("mrp/mrp-request/request-pengadaan-cetakan-rutin")?>" class="btn btn-warning"><?php print lang("Cancel")?></a>
                    <?php } ?>
