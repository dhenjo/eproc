...
<div class="row">
  <div class="col-xs-12">
    <div class="box box-solid box-success">
        <div class="box-header">
            <h3 class="box-title">List Request Pengadaan Technical Supply</h3>
            <div class="box-tools pull-right">
                <button class="btn btn-success btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <a href="<?php print site_url("mrp/mrp-request/add-request-pengadaan-technical")?>" title="Add Technical Supply" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
            </div>
