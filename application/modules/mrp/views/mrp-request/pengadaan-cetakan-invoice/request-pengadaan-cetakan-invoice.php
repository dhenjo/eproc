...
<div class="row">
  <div class="col-xs-12">
    <div class="box box-solid box-success">
        <div class="box-header">
            <h3 class="box-title">List Request Pengadaan Cetakan Invoice</h3>
            <div class="box-tools pull-right">
                <button class="btn btn-success btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <a href="<?php print site_url("mrp/mrp-request/add-request-pengadaan-cetakan-invoice")?>" title="Add Pengadaan Cetakan Invoice" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
            </div>
                ...
                <table class="table table-bordered table-hover" id="tableboxy">
                  <thead>
                    <tr>
                        ...
                        <th>Note</th>
                        <th>Status</th>
                        <th>Kode<br>Task<br>Order</th>
                        <th>Created<br> By User</th>
                        <th>Action</th>
                    </tr>
                  </thead>
                  <tbody id="data_list">
