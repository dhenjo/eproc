  ...
  <div class="col-xs-12">
    <div class="box box-solid box-success">
        <div class="box-header">
            <h3 class="box-title">List Permintaan Pengadaan Service</h3>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Note Service</h4>
            </div>
            ...
            <tfoot>
              ...
              <?php if($list[0]->status < 6){ ?>     
                ...
                <?php if($list[0]->status < 2){
                    ...
                    <a href="<?php print site_url("mrp/mrp-request/request-pengadaan-service")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
