  ...
  <div class="col-xs-12">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
             <li class="active"><a href="#view-umum" data-toggle="tab"><b>List Transportation</b></a></li>
            <?php
            if($list[0]->status < 6 OR $list[0]->status == 11 ){
            if($list[0]->id_mrp_request){
            ?>
            <li><a href="#umum" id="dt-umum" data-toggle="tab"><b>Transportation</b></a></li>
            <?php } }
        ...
        <div class="tab-content no-padding">
             <div class="chart tab-pane active" id="view-umum" style="position: relative; height: 300px;">
                <?php $this->load->view("mrp-request/pengadaan-umum/request-umum/view-request-pengadaan-umum"); ?>
            </div>
           <?php 
           if($list[0]->status < 6 OR $list[0]->status == 11){
           if($list[0]->id_mrp_request){
           ?>
           <div class="chart tab-pane " id="umum" style="position: relative; height: 300px;">
                 <?php $this->load->view('mrp-request/pengadaan-umum/request-umum/add-request-pengadaan-umum');?>
            </div>
           <?php } }
         if($this->session->userdata("id") == 1 OR $this->nbscache->get_olahan("permission", $this->session->userdata("id_privilege"), "request-mutasi-stock", "edit") !== FALSE){         
            if($this->session->userdata("id") == 1 OR $list[0]->status >= 3){
          ?>
            ...
            <div class="chart tab-pane " id="req-mutasi-stock" style="position: relative; height: 300px;">
                 <?php $this->load->view('mrp-request/pengadaan-umum/request-umum/mutasi-stock-department');?>
            </div>
            <div class="chart tab-pane " id="history-req-mutasi-stock" style="position: relative; height: 300px;">
                 <?php $this->load->view('mrp-request/pengadaan-umum/request-umum/history-mutasi');?>
            </div>
         <?php }
            }
         }
