    ...
    <div class="box box-solid box-success">
        <div class="box-header">
            ...
            <div class="widget-control pull-left">
              <span style="display: none; margin-left: 10px;" id="loader-mutasi"><img width="35px" src="<?php print $url?>img/ajax-loader.gif" /></span>
            </div>
        </div>
...
<div class="row">
  <div class="box">
    <div class="box-body table-responsive">
      <table class="table table-bordered table-hover" id="tableboxy-mutasi">
    <thead>
      <tr>
...
<tfoot>
  <tr>
    <td colspan="6">
        <button class="btn btn-primary" id="btn-proses-mutasi">Proses</button>
        <span style="display: none; margin-left: 10px;" id="loader-mutasi"><img width="35px" src="<?php print $url?>img/ajax-loader.gif" /></span>
    </td>
  </tr>
</tfoot>
