...
<!--                            <span class="input-group-addon">Note Cancel:</span>-->
        ...
        <div class="box-body">
            ...
            if($list[0]->id_mrp_request > 0){
               ...
               if($list[0]->create_by_users == $this->session->userdata("id") OR $this->nbscache->get_olahan("permission", $this->session->userdata("id_privilege"), "user_ro", "edit") !== FALSE OR $this->session->userdata("id") == 1){
           ...
           <div class="control-group">
            ...
            <?php }
              ...
              <div class="control-group">
               <div class="col-xs-6">
                  <label>Users Penerima Barang Sementara Dari Suplier</label>
                  <?php 
                  if($list[0]->name_receiver){
                      $name2 = $list[0]->name_receiver."<".$list[0]->name_organisasi_receiver.">"." <".$list[0]->email_receiver.">";
                  }else{
                      $name2 = "";
                  }
                  print $this->form_eksternal->form_input("users_penerima", $name2, 'id="users_penerima" class="form-control input-sm" placeholder="Users Penerima Barang"');
              ...
              <div class="box-body table-responsive">
                <table class="table table-bordered table-hover" id="tableboxy">
                  ...
                  <?php if($list[0]->status < 6){ ?>
                    ...
                    <a href="<?php print site_url("mrp/request-pengadaan-cetakan")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
                          <?php } ?>
...
<!--                      <td colspan="2"> 
              ...
              <tr>
                  <td colspan="3">
                      ...
                      <button class="btn btn-primary" id="btn-save">Save</button>
                      <a href="<?php print site_url("mrp/request-pengadaan-atk")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
                  </td>
              </tr>
               <?php }elseif($this->session->userdata("id") == 1 OR $this->nbscache->get_olahan("permission", $this->session->userdata("id_privilege"), "ro-akes-all", "edit") !== FALSE){ 
                  if($list[0]->status <= 6){  
                  ?>
                <tr>
                  <td colspan="3">
                    <button class="btn btn-primary" id="after-btn-save">Save</button>
                   <a href="<?php print site_url("mrp/request-pengadaan-cetakan")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
