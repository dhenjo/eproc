  ...
  <div class="col-xs-12">
    <div class="box box-solid box-success">
        <div class="box-header">
            <h3 class="box-title">List Request Pengadaan ATK</h3>
            <div class="box-tools pull-right">
                <button class="btn btn-success btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <!--<a href="<?php print site_url("mrp/add-request-pengadaan-atk")?>" title="Add ATK" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>-->
            </div>
              ...
              <div class="box-body table-responsive">
                  ...
                  <thead>
                    <tr>
                        ...
                        <th style="width: 150px">Mutasi Stock</th>
                        <!--<th>Action</th>-->
                    </tr>
                  </thead>
                  <tbody id="data_list">
