              ...
              <div class="box-body">
                ...
                <div class="control-group">
                 ...
                 <div class="control-group">
                  ...
                  <?php print $this->form_eksternal->form_dropdown("parent", $parent, 
                    array($detail[0]->direktorat), 'id="id_direktorat" class="form-control dropdown2 input-sm"');?>
                </div>
                  <span id="dt_department">
                <div class="control-group">
                    <label>Divisi</label>
                 <?php print $this->form_eksternal->form_dropdown("department", "", 
                ...
                <div class="control-group">
                 ...
                 <?php print $this->form_eksternal->form_dropdown("divisi", "", 
                   $detail[0]->section, ' class="form-control dropdown2 input-sm"');?>
                </div>
                   </span> 
              </div>
              <div class="box-footer">
                  <button class="btn btn-primary" type="submit">Save changes</button>
                  <a href="<?php print site_url("hr/hr-master/section")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div><!--/.col (left) -->
</div>   <!-- /.row -->
