            ...
            <?php print $this->form_eksternal->form_open("", 'role="form"', array("id_detail" => $detail[0]->id_guide_master))?>
              <div class="box-body">
                ...
                <div class="control-group">
                  ...
                  foreach($priv AS $pr){
                    $privilege_set[] = $pr->id_privilege;
                  }
                  print $this->form_eksternal->form_dropdown('id_privilege[]', $privilege, $privilege_set, 'class="form-control input-sm" multiple="multiple" style="height: 200px"');?>
                </div>
              ...
              <div class="box-footer">
                  ...
                  <a href="<?php print site_url("home/guide/master")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div><!--/.col (left) -->
</div>   <!-- /.row -->