        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open("", 'role="form"', 
              ...
              <div class="box-body">
                  ...
                  <label>Users</label>
                  <?php 
                  print $this->form_eksternal->form_input("users", $this->global_models->get_field("m_users", "name", 
                    array("id_users" => $detail[0]->id_users)), 'id="users" class="form-control input-sm" placeholder="users"');
