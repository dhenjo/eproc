        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open("", 'role="form"', 
              ...
              <div class="box-body">
                  ...
                  <?php print $this->form_eksternal->form_input("tgl_payment", $list[0]->tanggal_payment, ' id="tgl_payment" class="form-control date input-sm" placeholder="Tanggal Payment"'); ?>
                </div>
...
//            die('aa');
            ?>
              ...
              <div class="box-footer">
                  ...
                  <a href="<?php print site_url("mrp/list-po")?>" class="btn btn-warning"><?php print lang("cancel")?></a>
              </div>
        </div><!-- /.box -->
    </div>
