...
//        $this->load->library('PHPExcel');
    ...
    function mutasi_rg($id_mrp_stock_in = 0,$id_mrp_receiving_goods_po = 0,$id_mrp_inventory_spesifik = 0,$id_mrp_request = 0){
    ...
    $data2 = $this->global_models->get_query("SELECT B.id_hr_pegawai,"
...
//    if($stock_akhir >= $dt_jumlah){
        ...
        if($jumlah_stock >= $req_user[$ky]){
         ...
         $this->global_models->insert("mrp_stock_out", $kirim2);
